...
- [3. 機能要件 (Functional Requirements)](#3-機能要件-functional-requirements)
  - [3.1 Google Driveからの情報取得とスプレッドシートへの転記](#31-google-driveからの情報取得とスプレッドシートへの転記)
  - [3.2 抽出データの項目別整形](#32-抽出データの項目別整形)
  - [3.3 AWS S3へのデータ保存（中間データ）](#33-aws-s3へのデータ保存中間データ)
  - [3.4 Circusへの求職者登録](#34-circusへの求職者登録)
  - [3.5 Circus登録結果のS3への保存](#35-circus登録結果のs3への保存)
  - [3.6 Circus登録結果のスプレッドシートへの転記](#36-circus登録結果のスプレッドシートへの転記)
  - [3.7 登録済み求職者のマーク](#37-登録済み求職者のマーク)
  - [3.8 データのクリーンアップ](#38-データのクリーンアップ)
- [4. 非機能要件 (Non-Functional Requirements)](#4-非機能要件-non-functional-requirements)
  - [4.1 可用性](#41-可用性)
